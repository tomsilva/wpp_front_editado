                ...
                <MessageContent side={isMe}>
                    {
                        message.isMedia ? (
                            ...
                            <MessageContentText>
                                ...
                                <span style={{fontSize: 10, textAlign: "end"}}>
                                    {new Date(message.timestamp * 1000).getDate()}/{new Date(message.timestamp * 1000).getMonth()}/{new Date(message.timestamp * 1000).getFullYear()} - 
                                    {new Date(message.timestamp * 1000).getHours()}:{new Date(message.timestamp * 1000).getMinutes()}
                                </span>
                            </MessageContentText>
                        )
                    }
